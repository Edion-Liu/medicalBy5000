...
<script type="text/javascript">
	...
	function getOrderData() {
		$.ajax({
			type : "GET",
			url : "${basepath}/ajax/pay/tencent/getOutpatientOrderData",
			data : {
			...
			success : function(json) {
				if (json.status == 'ok'){
					...
					for(var n in data){
						...
						'		<label class="weui-form-preview__label">缴费信息</label>'+
						...
						'	<a class="weui-form-preview__btn weui-form-preview__btn_primary" href="${basepath}/view/pay/wxJsAPI/outpatientSeccess?outTradeNo='+data[n].outTradeNo+'">查看详情</a>'+
						'</div></div><br>'; 
					}
