		...
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>姓名：<span>刘万山</span></h4>
					<h4>科室：<span>门诊</span></h4>
					<h4>职称：<span>主任</span></h4>
					<h4>职务：<span>主任</span></h4>
				</div></div>
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_lws.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长白内障、青光眼、翼状胬肉、近视、远视、散光、斜视、弱视、泪道疾病、眼睑疾病、眼外伤等各种眼科疾病的手术与非手术治疗。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 大学本科学历，毕业于内蒙古民族大学。曾于白求医科大学二附院、通辽市医院、四平市中心医院进修。
                    </p> 
