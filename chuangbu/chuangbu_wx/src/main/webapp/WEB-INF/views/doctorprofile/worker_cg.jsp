	...
	<div class="container" id="container">
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            ...
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_cg.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长高血压脑出血、脑梗塞及脑梗塞超早期溶栓治疗、格林巴利综合症、多发性神经根炎、癫痫、危重病人的抢救等神经内科疾病;心律失常、急性心梗的溶栓治疗、急性大面积心肌梗塞的抢救等心血管疾病的治疗。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 党总支书记、副院长，大学学历，毕业于吉林医学院，曾于北京大学附属第一医院进修神经内科。
                    </p> 
					<h4 class="title">【出诊时间】</h4>
                    <p>
                     	 周一、二、四、五、周六 上午 
						 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 联系电话：0475-5212297、5212298 </br>
                    </p>
