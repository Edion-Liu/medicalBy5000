		...
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>姓名：<span>孙秀艳</span></h4>
					<h4>科室：<span>门诊</span></h4>
					<h4>职称：<span>主任</span></h4>
					<h4>职务：<span>主任</span></h4>
				</div></div>
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_sxy.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长脑血管病、癫痫及神经系统疑难病及其他复杂心内科疾病的诊治，对各种急危重症的抢救有丰富的临床经验。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 大学本科学历，毕业于内蒙古医学院，曾在白求恩医科大学附属第一医院神经内科进修。
                    </p> 
