		...
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>姓名：<span>王 宏</span></h4>
					<h4>科室：<span>门诊</span></h4>
					<h4>职称：<span>主任</span></h4>
					<h4>职务：<span>主任</span></h4>
				</div></div>
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_wh.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长高血压、冠心病、心衰、心血管危重症等心内科疾病的诊治以及脑血管病、慢性阻塞性肺疾病等其他内科疾病的诊治。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 大学本科学历，毕业于内蒙古医学院，曾于北京医科大学三院急诊科、心内科进修学习。
                    </p> 
					<h4 class="title">【出诊时间】</h4>
                    <p>
                     	 周一、二、四、五、周六 上午 
						 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 联系电话：13947597272 </br>
                    </p>
