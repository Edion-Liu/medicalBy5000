		...
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>姓名：<span>王浩伟</span></h4>
					<h4>科室：<span>门诊</span></h4>
					<h4>职称：<span>主任</span></h4>
					<h4>职务：<span>主任</span></h4>
				</div></div>
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_whw.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长儿童神经系统、心血管系统、呼吸系统及变态反应性等疾病的诊治，疑难病症诊断及危重病人的抢救方面具有较丰富的经验。先后在国家级医学期刊发表论文14篇。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 儿科主任，大学专科学历，毕业于包头医学院，曾在吉林省人民医院儿科、清华大学第一附属医院新生儿科进修。
                    </p> 
					<h4 class="title">【出诊时间】</h4>
                    <p>
                     	 周一至周五全天，周六上午 
						 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 联系电话：13134752533 </br>
                    </p>
