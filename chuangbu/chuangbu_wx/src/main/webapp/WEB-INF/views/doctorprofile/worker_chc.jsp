		...
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>姓名：<span>陈唤春</span></h4>
					<h4>科室：<span>门诊</span></h4>
					<h4>职称：<span>主任</span></h4>
					<h4>职务：<span>主任</span></h4>
				</div></div>
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_chc.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长子宫肌瘤、卵巢囊肿、更年期相关疾病诊断和治疗，擅长妊娠合并症、孕期保健、产科合并症的诊断处理，危重症的抢救，异常产程的管理，产科手术。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 大学专科学历，毕业于内蒙古科技大学，曾于白求恩医科大学第一临床医院、第二临床医院、清华大学第一附属医院妇产科进修。
                    </p> 
					<h4 class="title">【出诊时间】</h4>
                    <p>
                     	 周一、二、四、五、周六 上午 
						 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 联系电话：13451351866 </br>
                    </p>
