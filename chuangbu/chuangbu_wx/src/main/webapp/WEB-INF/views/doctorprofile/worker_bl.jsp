		...
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>姓名：<span>包 伶</span></h4>
					<h4>科室：<span>门诊</span></h4>
					<h4>职称：<span>主任</span></h4>
					<h4>职务：<span>主任</span></h4>
				</div></div>
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_bl.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长顽固性心衰、急性心肌梗塞及合并症、常见心律失常的诊治及心源性休克的抢救、心脏骤停的抢救。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 急诊医学科主任，大学本科学历，毕业于内蒙古医学院，曾在北京医科大学第一附属医院心内科、清华大学第一附属医院急诊医学科进修。
                    </p> 
					<h4 class="title">【出诊时间】</h4>
                    <p>
                     	 周一、二、四、五、周六 上午 
						 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 联系电话：0475-5225131 </br>
                    </p>
