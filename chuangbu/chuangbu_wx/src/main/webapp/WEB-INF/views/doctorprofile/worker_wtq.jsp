		...
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>姓名：<span>王铁强</span></h4>
					<h4>科室：<span>门诊</span></h4>
					<h4>职称：<span>主任</span></h4>
					<h4>职务：<span>主任</span></h4>
				</div></div>
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_wtq.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长脑出血、脑梗塞、冠心病、心衰、慢性阻塞性肺疾病、支气管哮喘等内科急慢性疾病的诊治以及内科各种急危重症的抢救和治疗。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 大学本科学历，毕业于内蒙古医学院，曾于白求恩医科大学第一临床医学院心血管内科进修。
                    </p> 
					<h4 class="title">【出诊时间】</h4>
                    <p>
                     	 周一、二、四、五、周六 上午 
						 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 联系电话：13948138195 </br>
                    </p>
