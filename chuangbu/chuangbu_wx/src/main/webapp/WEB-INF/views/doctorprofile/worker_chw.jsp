...
<body ontouchstart>
	...
	<div class="container" id="container">
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长神经血管吻合术、 甲状腺、乳腺、肝胆胰及胃肠道疾病的外科治疗及各种创伤的急救；熟练掌握结肠镜的检查与诊断技术。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 大学本科学历，毕业于大连医科大学。曾于中国医科大学附属第一医院骨科、沈阳奉天医院手外科、通辽市医院普外科进修。
                    </p> 
