		...
		<div class="page js_show" >
	        ...
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>姓名：<span>郭志强</span></h4>
					<h4>科室：<span>门诊</span></h4>
					<h4>职称：<span>主任</span></h4>
					<h4>职务：<span>主任</span></h4>
				</div></div>
	            <div class="weui-flex__item"><div class="placeholder">
					<img src="./../../myres/img/doctor/worker_gzq.jpg" alt="" >
				</div></div>
	        </div>
	        <div class="weui-flex doctor-flex" >
	            <div class="weui-flex__item"><div class="placeholder">
					<h4>擅长：<span>擅长脑出血、脑梗塞、高血压、冠心病、急慢性心力衰竭等内科常见病的诊治以及休克、各种中毒等急危重症的急救。 </span></h4>
				</div></div>
	        </div>
			...
			<article class="weui-article">
	            <section>
                    ...
                    <p>
                     	 大学本科学历，毕业于内蒙古民族大学。曾在包头医学院进修全科医师。
                    </p> 
