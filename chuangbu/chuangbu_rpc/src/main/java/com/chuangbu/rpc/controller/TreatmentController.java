...
import com.chuangbu.rpc.service.TreatmentService;
...
public class TreatmentController extends AdstractController {
    ...
    public String pageData(@RequestParam("token") String token,@RequestParam("pageSize") String pageSize,
		...
		if(validateToken(token)){
			JSONArray arvert = JSONArray.fromObject(treatmentService.findByGeneralName(generalName));  
